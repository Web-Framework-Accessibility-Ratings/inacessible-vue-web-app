<template>
    <div>
        <h1>Some inaccessible content without a role</h1>
            <p>
                Lorem <a v-bind:style="{border: 'medium solid black', borderRadius: '2px'}" href="/">ipsum</a> dolor sit amet, consectetur adipiscing elit. 
                ...
                tempus bibendum. <a v-bind:style="{border: 'medium solid black', borderRadius: '2px'}"  href="/">Phasellus</a> erat mauris, laoreet et quam ac, 
